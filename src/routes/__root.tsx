...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pécule, l'app qui vous aide à voir, comprendre, épargner et investir votre argent." },
      { property: "og:title", content: "Pécule — Reprenez le contrôle de vos finances" },
      { property: "og:description", content: "Pécule, l'app qui vous aide à voir, comprendre, épargner et investir votre argent." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "Pécule — Reprenez le contrôle de vos finances" },
      { name: "twitter:description", content: "Pécule, l'app qui vous aide à voir, comprendre, épargner et investir votre argent." },
