...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "FinEase — Reprenez le contrôle de vos finances" },
      { name: "description", content: "FinEase, l'app qui vous aide à voir, comprendre, épargner et investir votre argent." },
      { property: "og:title", content: "FinEase — Reprenez le contrôle de vos finances" },
      { property: "og:description", content: "FinEase, l'app qui vous aide à voir, comprendre, épargner et investir votre argent." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "FinEase — Reprenez le contrôle de vos finances" },
      { name: "twitter:description", content: "FinEase, l'app qui vous aide à voir, comprendre, épargner et investir votre argent." },
